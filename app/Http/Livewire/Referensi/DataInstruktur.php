...
class DataInstruktur extends Component
{
    ...
    public function store(){
        ...
        $this->validate(
            [
                'nama.*' => 'required',
                'nik.*' => 'required|numeric|digits:4|unique:guru,nik',
    ...
    public function perbaharui(){
        ...
        $this->validate(
            [
                ...
                'nik' => ['required', 'digits:4', 'numeric', Rule::unique('guru')->ignore($this->guru_id, 'guru_id')]
            ],
            [
                'email.required' => 'Email tidak boleh kosong!',
                ...
                'nik.unique' => 'NIK sudah terdaftar!',
                'nik.numeric' => 'NIK harus berupa angka!',
                'nuptk.digits' => 'NUPTK harus 4 digit!',

                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control form-control-sm" wire:model.defer="alamat.{{$urut}}"></td>
                                    {{-- <td class="text-center">{{$loop->iteration}}</td> --}}
                                    <td><input type="text" class="form-control form-control-xs" wire:model.defer="rt.{{$urut}}">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control form-control-xs" wire:model.defer="rw.{{$urut}}">
                                    </td>
                                    ...
                                    <td><input type="text" class="form-control form-control-sm" wire:model.defer="kordinator.{{$urut}}"></td>
                                    <td><input type="text" class="form-control form-control-sm" wire:model.defer="no_hp.{{$urut}}"></td>
                                    {{-- <td>

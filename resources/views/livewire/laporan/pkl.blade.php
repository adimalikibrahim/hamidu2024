                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9" wire:ignore>
                                <select id="dudi_id" class="form-select" wire:model="dudi_id" data-pharaonic="select2"
                                    data-component-id="{{ $this->id }}" data-placeholder="== Pilih DUDI ==">
                    ...
                    <div class="card-body">
                        <div class="alert alert-danger alert-block">
                            <div class="alert-body">
                                ...
                                @if (!$semester_allowed)
                                    <p>Kurikulum <strong>{{ $nama_kurikulum }}</strong>, Praktik Kerja Lapangan hanya untuk
                                        kelas <strong>{{ $tingkat }}</strong>, Semester Genap</p>
                                @else
                                    <p>Kurikulum <strong>{{ $nama_kurikulum }}</strong>, Praktik Kerja Lapangan hanya untuk
                                        kelas <strong>{{ $tingkat }}</strong></p>
                                @endif
                            </div>
                        </div>
                    </div>

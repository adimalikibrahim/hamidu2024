                                        ...
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark"
                                                ...
                                                <li><a class="dropdown-item" href="javascript:void(0)"
                                                        wire:click="getId('{{ $item->prestasi_id }}', 'edit')"
                                                        title="Edit Data"><i class="fa fa-pencil"></i> Edit Data</a>
                                                </li>
                                                <li><a class="dropdown-item" href="javascript:void(0)"
                                                        wire:click="getId('{{ $item->prestasi_id }}', 'delete')"
                                                        title="Hapus Data"><i class="fas fa-trash"></i> Hapus Data</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>

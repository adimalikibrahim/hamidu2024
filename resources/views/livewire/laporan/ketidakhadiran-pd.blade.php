        ...
        <tbody>
            @foreach ($data_siswa as $siswa)
                <tr>
                    <td>{{ $siswa->nama }}</td>
                    @if ($form)
                        <td><input type="number" class="form-control" wire:ignore
                                wire:model.lazy="sakit.{{ $siswa->anggota_rombel->anggota_rombel_id }}" /></td>
                        <td><input type="number" class="form-control" wire:ignore
                                wire:model.lazy="izin.{{ $siswa->anggota_rombel->anggota_rombel_id }}" /></td>
                        <td><input type="number" class="form-control" wire:ignore
                                wire:model.lazy="alpa.{{ $siswa->anggota_rombel->anggota_rombel_id }}" /></td>
                    @else

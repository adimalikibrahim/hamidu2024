                                    ...
                                    <td>
                                        @if ($item->anggota_kewirausahaan)
                                            {!! $item->peserta_didik->nama .
                                                ...
                                                implode(
                                                    '<br>',
                                                    $item->anggota_kewirausahaan->map(function ($anggota) {
                    ...
                    <div class="modal-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9" wire:ignore>
                                <select id="anggota_rombel_id" class="form-select" wire:model="anggota_rombel_id"
                                    data-pharaonic="select2" data-component-id="{{ $this->id }}"
                                    data-parent="#addModal" data-placeholder="== Pilih Siswa =="
                                    wire:change="changeSiswa">
                                    <option value="">== Pilih Siswa ==</option>
                                    @foreach ($data_siswa as $siswa)
                                        <option value="{{ $siswa->anggota_rombel->anggota_rombel_id }}">
                                            {{ $siswa->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-2{{ $show ? '' : ' d-none' }}">
                            ...
                            <div class="col-sm-9" wire:ignore>
                                <select id="pola" class="form-select" wire:model="pola" data-pharaonic="select2"
                                    data-component-id="{{ $this->id }}" data-parent="#addModal"
                                    data-placeholder="== Pilih Pola Kewirausahaan ==" wire:change="changePola">
                        ...
                        <div class="row mb-2{{ $kelompok ? '' : ' d-none' }}">
                            <label for="anggota_wirausaha_id" class="col-sm-3 control-label">Anggota
                                Kewirausahaan</label>
                            <div class="col-sm-9" wire:ignore>
                                <select wire:model="anggota_wirausaha_id" id="anggota_wirausaha_id" class="form-control"
                                    data-pharaonic="select2" data-component-id="{{ $this->id }}"
                                    data-parent="#addModal" data-placeholder="== Pilih Pola Kewirausahaan =="
                        ...
                        <div class="row mb-2{{ $show ? '' : ' d-none' }}">
                            ...
                            <div class="col-sm-9" wire:ignore>
                                <select id="jenis_usaha" class="form-select" wire:model="jenis_usaha"
                                    data-pharaonic="select2" data-component-id="{{ $this->id }}"
                                    data-parent="#addModal" data-placeholder="== Pilih Jenis Kewirausahaan ==">

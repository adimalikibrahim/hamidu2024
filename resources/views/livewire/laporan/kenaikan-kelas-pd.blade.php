                ...
                <tr>
                    ...
                    <td>
                        @role('wali', session('semester_id'))
                            <div wire:ignore>
                                @if ($rombel_empat_tahun)
                                    <select wire:model="status.{{ $siswa->anggota_rombel->anggota_rombel_id }}"
                    ...
                    @if ($tingkat < 12 || $rombel_empat_tahun)
                        <td>
                            <input type="text"
                                wire:model.defer="nama_kelas.{{ $siswa->anggota_rombel->anggota_rombel_id }}"
                                class="form-control">
                            <input type="hidden"
                                wire:model="rombongan_belajar_id.{{ $siswa->anggota_rombel->rombongan_belajar_id }}"
                                class="form-control">
                        </td>
                    @endif
                </tr>

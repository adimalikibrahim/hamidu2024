                ...
                <form wire:ignore.self wire:submit.prevent="store">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <select id="jurusan_sp_id" class="form-select" wire:model="jurusan_sp_id"
                                    wire:change="changeJurusan">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <select id="rombongan_belajar_id" class="form-select" wire:model="rombongan_belajar_id"
                                    wire:change="changeRombel">
                                    <option value="">== Pilih Rombongan Belajar ==</option>
                                    @foreach ($data_rombongan_belajar as $rombongan_belajar)
                                        <option value="{{ $rombongan_belajar->rombongan_belajar_id }}">
                                            {{ $rombongan_belajar->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-9">
                                <select id="pembelajaran_id" class="form-select" wire:model="pembelajaran_id"
                                    wire:change="changePembelajaran">
                                    <option value="">== Pilih Mata Pelajaran ==</option>
                                    @foreach ($data_pembelajaran as $pembelajaran)
                                        <option value="{{ $pembelajaran->pembelajaran_id }}">
                                            {{ $pembelajaran->nama_mata_pelajaran }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

                                        ...
                                        <div class="btn-group dropstart">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-dark"
                                                ...
                                                <li><a class="dropdown-item" href="javascript:void(0)"
                                                        wire:click="getID('{{ $item->catatan_ppk_id }}', 'view')"
                                                        title="Lihat Detil"><i class="fas fa-eye"></i> Detil</a></li>
                                                <li><a class="dropdown-item" href="javascript:void(0)"
                                                        wire:click="getID('{{ $item->catatan_ppk_id }}', 'hapus')"
                                                        title="Hapus Data"><i class="fas fa-trash"></i> Hapus</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-content">
                ...
                <form wire:ignore.self wire:submit.prevent="store">
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <label class="col-sm-3 col-form-label">Catatan Penilaian Sikap Integritas <br>
                                <strong>{{ $nama_siswa }}</strong></label>
                            <div class="col-sm-9">
                                Catatan nilai sikap dari guru:
                                @if (count($nilai_sikap))
                                    <ul class="ps-1">
                                        @foreach ($nilai_sikap as $ns)
                                            <li>{{ $ns->guru->nama }} <i class="fa-solid fa-hand-point-right"></i>
                                                {{ $ns->uraian_sikap }} ({{ $ns->opsi_sikap }})</li>
                                        @endforeach
                                    </ul>
                                @endif
                            </div>
                        ...
                        <tbody>
                            ...
                            @if ($catatan_ppk)
                                @forelse ($catatan_ppk->nilai_karakter as $nilai_karakter)
                                    <tr>
                                        <td style="vertical-align:middle;">Catatan Penilaian Sikap
                                            {{ $nilai_karakter->sikap->butir_sikap }}</td>
                                        <td style="vertical-align:middle;">:</td>
